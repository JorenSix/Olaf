...
Download "@olaf_c.exe@ here":https://github.com/JorenSix/Olaf/tree/master/pre-built and copy it to a fixed location.

Download "olaf.rb":https://github.com/JorenSix/Olaf/blob/master/olaf.rb, open it in a text editor and modify the "EXECUTABLE_LOCATION".

Now you can call olaf as follows:
