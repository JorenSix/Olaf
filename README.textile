...
In a more copy-paste friendly way the following demonstrates example use of Olaf:
...
cp dataset/ref/173050.mp3 dataset/ref/173050_dup.mp3
olaf dedup dataset/ref

#delete the duplicate from the index:
olaf delete dataset/ref/173050_dup.mp3
rm  dataset/ref/173050_dup.mp3
</pre>
