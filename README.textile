...
The power of Zig is, however, more obvious when an other target is provided. For a list of platforms, please consult the output of @zig targets@. To build a windows executable run the following commands. Afterwards, pre-built windows executable can be found in @pre-built@
